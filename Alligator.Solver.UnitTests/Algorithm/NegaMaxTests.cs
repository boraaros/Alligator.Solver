...
//            var rules = new Mock<IRules<TestPosition, TesTMove>>(MockBehavior.Strict);
//            rules
//                .Setup(t => t.InitialPosition())
//                .Returns(new TestPosition((id) => false, (id) => false, (id) => true));
//            rules
//                .Setup(t => t.LegalMovesAt(It.IsAny<TestPosition>()))
...
//                rules.Object, cacheTables.Object, heuristicTables.Object, miniMaxSettings);
...
//            //rules.Verify(t => t.StaticEvaluate(It.Is<TestPosition>(p => p.Identifier == 6ul)), Times.Never);
//        }
